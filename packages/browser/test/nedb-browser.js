              ...
              db.update(
                ...
                function (err, nr) {
                  ...
                  db.find({}, function (err, docs) {
                    assert.equal(docs.length, 2);
                    assert.equal(
                      findById(docs, newDoc1._id).planet,
                      "Eaaaaarth"
                    );
                    assert.equal(findById(docs, newDoc2._id).planet, "Saturn");
                    ...
                    db.update(
                      ...
                      function (err, nr) {
                        ...
                        db.find({}, function (err, docs) {
                          ...
                          assert.equal(
                            findById(docs, newDoc2._id).planet,
                            "Saturn"
                          );
                          ...
                          db.update(
                            ...
                            function (err, nr) {
                              ...
                              db.find({}, function (err, docs) {
                                ...
                                assert.equal(
                                  findById(docs, newDoc1._id).count,
                                  3
                                );
                                assert.equal(
                                  findById(docs, newDoc2._id).planet,
                                ...
                                assert.equal(
                                  findById(docs, newDoc2._id).count,
                                  3
                                );
      ...
      db.insert({ a: 6 }, function () {
        db.insert({ a: 7 }, function () {
          db.getCandidates({ a: 6 }, function (err, candidates) {
            ...
            assert.isDefined(
              _.find(candidates, function (doc) {
                return doc.a === 4;
              })
            );
            assert.isDefined(
